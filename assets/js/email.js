...
function sendRequest() {
  ...
  try {
    ...
    jQuery("#contactWrapper").append(
      '<div class="success"><h4>Message Envoyé!!</h4><br><p>Merci pour votre confiance, Mr/Mme <strong>' +
        decodeURIComponent(name) +
        "</strong>! Votre demande a bien été envoyé! Nous revenons vers vous dans les plus brefs délais.</p></div>"
    );
  }
}
...
function sendRequest_news() {
  ...
  try {
    ...
    jQuery("#newsletterform")
      .parent()
      .append('<div class="success"><h4>Subscription Successfully Sent!</h4><br><p>Your email: ' + email + " has been registered.</p></div>");
  }
}
...
function check_values() {
  ...
  if ($j("#contactform #name").val() != undefined)
    if ($j("#contactform #name").val() == "") {
      ...
      if (!hasClass) $j("#contactform #name").parent().append('<label for="contactname" generated="true" class="error">Please enter your name</label>');
  ...
  if ($j("#contactform #body").val() != undefined)
    if ($j("#contactform #body").val() == "") {
      ...
      if (!hasClass) $j("#contactform #body").parent().append('<label for="contactname" generated="true" class="error">You need to enter a message!</label>');
...
function check_values_loans() {
  ...
  if ($j("#contactform #name").val() != undefined)
    if ($j("#contactform #name").val() == "") {
      var hasClass = $j("#contactform #name").parent().find(".error").hasClass("error");
      if (!hasClass) $j("#contactform #name").parent().append('<label for="contactname" generated="true" class="error">Please enter your first name</label>');
      $j("#contactform #name").focus();
      //return false;
      errors++;
    } else $j("#contactform #name").parent().find(".error").remove();
...
function check_values_booking() {
  ...
  if ($j("#contactform_booking #name").val() != undefined)
    if ($j("#contactform_booking #name").val() == "") {
      ...
      if (!hasClass) $j("#contactform_booking #name").parent().append('<label for="contactname" generated="true" class="error">Please enter your name</label>');
  ...
  if ($j("#contactform_booking #adults").val() == "") {
    ...
    if (!hasClass) $j("#contactform_booking #adults").parent().append('<label for="contactname" generated="true" class="error">Please enter adults nr</label>');
  ...
  if ($j("#contactform_booking #rooms").val() == "") {
    ...
    if (!hasClass) $j("#contactform_booking #rooms").parent().append('<label for="contactname" generated="true" class="error">Please enter rooms nr</label>');
...
function check_values_popup() {
  ...
  if ($j("#contactform_popup #name_popup").val() != undefined)
    if ($j("#contactform_popup #name_popup").val() == "") {
      ...
      //return false;
      errors++;
    } else $j("#contactform_popup #name_popup").parent().find(".error").remove();
    ...
    if (validate_email($j("#contactform_popup #email_popup").val()) == false) {
      ...
      if (!hasClass)
        $j("#contactform_popup #email_popup")
          .parent()
          .append('<label for="contactname" generated="true" class="error">Please enter a valid email address</label>');
      $j("#contactform_popup #email_popup").focus();
      //return false;
      errors++;
    } else $j("#contactform_popup #email_popup").parent().find(".error").remove();
  ...
  if ($j("#contactform_popup #subject").val() != undefined)
    if ($j("#contactform_popup #subject_popup").val() == "") {
      ...
      //return false;
      errors++;
    } else $j("#contactform_popup #subject_popup").parent().find(".error").remove();
  ...
  if ($j("#contactform_popup #body_popup").val() != undefined)
    if ($j("#contactform_popup #body_popup").val() == "") {
      ...
      //return false;
      errors++;
    } else $j("#contactform_popup #body_popup").parent().find(".error").remove();
...
function check_values_news() {
  ...
  if ($j("#newsletterform #name_news").val() != undefined)
    if ($j("#newsletterform #name_news").val() == "") {
      ...
      if (!hasClass) $j("#newsletterform #name_news").parent().append('<label for="contactname" generated="true" class="error">Please enter your name</label>');
