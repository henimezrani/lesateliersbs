      ...
      $("div[data-id]").each(function () {
        ...
        if (first) {
          ...
          if (newActive) {
            ...
            menu
              .find("li")
              .removeClass("current-menu-item current-menu-parent current-menu-ancestor current_page_item current_page_parent current_page_ancestor");
      ...
      if (!jQuery("body").hasClass("one-page")) {
        ...
        if (menu.find("li.scroll").length > 1) {
          menu
            ...
            .removeClass("current-menu-item currenet-menu-parent current-menu-ancestor current_page_item current_page_parent current_page_ancestor");
          // menu item click
